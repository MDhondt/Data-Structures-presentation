...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}[scale=0.5,every node/.style={circle,transform shape,draw,minimum width=8mm}]
			\node[label={[yshift=-2mm]\scriptsize{$7$}}] (7) at (0,0) {2};
			\node[label={[yshift=-2mm]\scriptsize{$3$}}] (3) at (.75,1) {8};
			\node[label={[yshift=-2mm]\scriptsize{$8$}}] (8) at (1.5,0) {4};
			\node[label={[yshift=-2mm]\scriptsize{$1$}}] (1) at (2.25,2) {14};
			\node[label={[yshift=-2mm]\scriptsize{$9$}}] (9) at (3,0) {1};
			\node[label={[yshift=-2mm]\scriptsize{$4$}}] (4) at (3.75,1) {7};
			\node[label={[yshift=-2mm]\scriptsize{$0$}}] (0) at (4.5,3) {16};
			\node[label={[yshift=-2mm]\scriptsize{$5$}}] (5) at (5.25,1) {9};
			\node[label={[yshift=-2mm]\scriptsize{$2$}}] (2) at (6.75,2) {10};
			\node[label={[yshift=-2mm]\scriptsize{$6$}}] (6) at (8.25,1) {3};
			\draw (0) -- (1) (0) -- (2) (1) -- (3) (1) -- (4) (3) -- (7) (3) -- (8) (4) -- (9) (2) -- (5) (2) -- (6);
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$0$}},minimum width=8mm,minimum height=8mm] (a0) at (10.8,1) {16};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$1$}},minimum width=8mm,minimum height=8mm] (a1) at (11.6,1) {14};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$2$}},minimum width=8mm,minimum height=8mm] (a2) at (12.4,1) {10};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$3$}},minimum width=8mm,minimum height=8mm] (a3) at (13.2,1) {8};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$4$}},minimum width=8mm,minimum height=8mm] (a4) at (14,1) {7};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$5$}},minimum width=8mm,minimum height=8mm] (a5) at (14.8,1) {9};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$6$}},minimum width=8mm,minimum height=8mm] (a6) at (15.6,1) {3};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$7$}},minimum width=8mm,minimum height=8mm] (a7) at (16.4,1) {2};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$8$}},minimum width=8mm,minimum height=8mm] (a8) at (17.2,1) {4};
			\node[rectangle,label={[yshift=-5.5mm,xshift=-3mm]\tiny{$9$}},minimum width=8mm,minimum height=8mm] (a9) at (18,1) {1};
